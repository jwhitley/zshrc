...
vim-mode-bindkey viins       -- redisplay                          '^R'
...
vim-mode-bindkey viins vicmd -- edit-command-line                  '^X'
...
if [[ -n $HISTORY_SUBSTRING_SEARCH_HIGHLIGHT_FOUND ]]; then
    ...
    vim-mode-bindkey       vicmd -- history-beginning-search-up         'k'
    vim-mode-bindkey       vicmd -- history-beginning-search-down       'j'
fi

# incremental search {{{1
vim-mode-bindkey       vicmd -- history-incremental-pattern-search-backward '/'
vim-mode-bindkey       vicmd -- history-incremental-pattern-search-forward  '?'
vim-mode-bindkey isearch     -- history-incremental-search-backward         '^P'
vim-mode-bindkey isearch     -- history-incremental-search-forward          '^N' 
